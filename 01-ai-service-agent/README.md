...
- 体验前：用户会咨询项目介绍、适合人群、预约方式、注意事项等基础信息。
- 体验前决策：用户可能需要根据偏好选择更适合自己的体验路线、角色或参与方式。
- 体验后：用户会继续追问剧情、人物关系、隐藏线索、体验复盘等内容。
...
用户表达偏好后，AI 客服管家根据用户的兴趣、接受度、互动偏好等信息，给出适合的体验建议。公开展示版本只保留推荐逻辑，不包含真实角色或真实剧情。

### 3. 体验后复盘

用户体验结束后，可以围绕内容线索、人物关系或体验感受继续追问。AI 客服管家负责提供非敏感、非剧透或可控剧透范围内的复盘回答。
